...
-- Tipul de teren: rezidential, industrial, agricol, pasune, ferma sau padure
CREATE TYPE tip_teren_enum AS ENUM ('rezidential', 'industrial', 'agricol', 'pasune', 'ferma', 'padure');
